...
data class Summary(
	 ...
	 */
	@Serializable
	data class Lesson(val availableAt: Timestamp, val subjectIds: List<ID>)
	 ...
	 */
	@Serializable
	data class Review(val availableAt: Timestamp, val subjectIds: List<ID>)
}
